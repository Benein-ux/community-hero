...
export default function Home() {
  ...
  return (
    <div className="relative h-[calc(100vh-3.5rem)] w-full">
      ...
      <button
        onClick={fetchIssues}
        className="absolute bottom-6 left-6 z-[1000] flex items-center justify-center w-12 h-12 bg-[#0a0a0c]/90 backdrop-blur-xl border border-white/[0.08] text-[var(--fg-muted)] rounded-2xl shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_4px_16px_rgba(0,0,0,0.4)] hover:bg-[#0a0a0c] hover:text-[var(--fg)] hover:border-white/[0.12] transition-all duration-200 ease-out active:scale-95"
        title="Refresh Map"
      >
        <RotateCcw size={18} />
      </button>
